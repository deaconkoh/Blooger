        ...
        <ul class="list-unstyled">
          <?php while ($post = $user_posts->fetch_assoc()): ?>
            <li class="mb-2">
              ...
              <a href="edit_post.php?id=<?= $post['post_id'] ?>" class="text-warning">Edit</a>
              <a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#deletePostModal" 
                 data-post-id="<?= $post['post_id'] ?>" 
                 data-post-title="<?= htmlspecialchars($post['title']) ?>">Delete</a>
            </li>
          <?php endwhile; ?>
        </ul>
      </div>
